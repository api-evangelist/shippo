...
**APIs.json:** [https://raw.githubusercontent.com/api-evangelist/shippo/refs/heads/main/apis.yml](https://raw.githubusercontent.com/api-evangelist/shippo/refs/heads/main/apis.yml)
...
- [OpenAPI](openapi/shippo-openapi.yml) — [OpenAPI Specification](https://spec.openapis.org/oas/latest.html)
- [Postman Collection](collections/shippo.postman_collection.json) — [Postman Collection 2.1](https://schema.getpostman.com/json/collection/v2.1.0/collection.json)
- [Open Collection](collections/shippo.opencollection.json) — [Open Collection 1.0](https://schema.opencollection.com/opencollection/v1.0.0.json)
- [AsyncAPI](asyncapi/shippo-webhooks-asyncapi.yaml) — [AsyncAPI Specification](https://www.asyncapi.com/docs/reference/specification/latest)
- [OpenAPI](https://docs.goshippo.com/spec/shippoapi/public-api.yaml) — [OpenAPI Specification](https://spec.openapis.org/oas/latest.html)
...
- [JSON Schema](json-schema/shippo-shipment-schema.json) — [JSON Schema](https://json-schema.org/specification)
- [JSON Schema](json-schema/shippo-transaction-schema.json) — [JSON Schema](https://json-schema.org/specification)
- [JSON-LD](json-ld/shippo-context.jsonld) — [JSON-LD](https://www.w3.org/TR/json-ld11/)
- [Spectral Rules](rules/shippo-rules.yml)
...
- [S D Ks](https://docs.goshippo.com/docs/guides_general/clientlibraries)
...
- [Features](undefined)
- [Integrations](https://goshippo.com/integrations)
- [Agent Skill](https://github.com/goshippo/shippo-clawhub-skill)
- [L L Ms Txt](https://docs.goshippo.com/llms.txt)
